...
const SEED = [
  ...
  ['1f575027600618cabf8a3516601dfd29', '무결점 조화의 결정체',  '유니크',   '재료',   900, '중빈도', '100건 = 240분치'],
  ['0ecd816e640341e04fc5c9a0715d91a8', '시간의 결정',           '유니크',   '재료',  3600, '저빈도', '47건이 30일치. 백필만으로 한 달 그래프 확보'],
] as const;
